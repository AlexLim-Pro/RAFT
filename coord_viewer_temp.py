...
def clear_plots(*args, **kwargs):
    ...
    :param kwargs: Unused parameter to allow function to work as a callback
    """
    # if have_cleared_view:
    #     fig.canvas.restore_region(map_clear_view)
    #     fig.canvas.blit(fig.bbox)
    #     fig_graph.canvas.restore_region(graph_clear_view)
    #     fig_graph.canvas.blit(fig_graph.bbox)
    #     return
    for path in p:
        try:
...
def reset(*args, **kwargs):
    ...
    #     plt.rcParams['axes.prop_cycle'][i] = to_rgba(col, alpha)
    ...
    return
    # if have_default_view:
    #     fig.canvas.restore_region(map_default_view)
    #     fig.canvas.blit(ax.bbox)
    #     fig_graph.canvas.restore_region(graph_default_view)
    #     fig_graph.canvas.blit(ax_graph.bbox)
    #     redraw_canvases()
    #     return
    for path in p:
        p[path].set_alpha(1)
...
#
# ##### Bliting #####
# print("Initializing bliting")
# map_default_view = fig.canvas.copy_from_bbox(fig.bbox)
# fig.canvas.blit(fig.bbox)
# graph_default_view = fig_graph.canvas.copy_from_bbox(fig_graph.bbox)
# fig_graph.canvas.blit(fig_graph.bbox)
# clear_plots()
# redraw_canvases()
# map_clear_view = fig.canvas.copy_from_bbox(fig_graph.bbox)
# fig.canvas.blit(fig.bbox)
# graph_clear_view = fig_graph.canvas.copy_from_bbox(fig_graph.bbox)
# fig_graph.canvas.blit(fig_graph.bbox)
#
# # fig.canvas.restore_region(map_default_view)
# # fig.canvas.blit(ax.bbox)
...
# reset()
#
# have_default_view = True
# have_cleared_view = True
#
# reset()
#
# print("Finished bliting")
